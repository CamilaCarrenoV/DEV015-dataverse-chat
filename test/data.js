...
export const data = [
  {
    ...
    name: "Elemental",
    shortDescription:
      "Explora un mundo donde los elementos naturales cobran vida y coexisten en una vibrante ciudad.",
    description:
    ...
    imageUrl:
      "https://es.web.img3.acsta.net/pictures/23/05/17/10/28/2036083.jpg",
    facts: {
      estreno: "2023",
    ...
    extraInfo: {
      curiosidades:
        "Para crear el efecto visual del personaje de Ember, el equipo de animación desarrolló nuevas técnicas para capturar la fluidez y el dinamismo del fuego de una manera realista y expresiva.",
    },
  },
  {
    id: "pixar-up",
    name: "UP",
    shortDescription:
      "Aventuras emocionantes de un anciano y un niño explorador en una casa voladora impulsada por globos.",
    description:
  ...
  },
  {
    ...
    name: "Coco",
    shortDescription:
      "Una celebración musical y visual que explora la importancia de la familia y la memoria.",
    description:
    ...
    extraInfo: {
      curiosidades:
        "Coco fue elogiada por su representación auténtica de la cultura mexicana, desde sus tradiciones hasta la música mariachi. Ganó dos Premios de la Academia, incluyendo Mejor Película Animada y Mejor Canción Original por Recuerdame.",
    },
  },
  {
    ...
    name: "Intensamente",
    shortDescription:
      "Explora las emociones humanas a través de la historia de Riley y las cinco emociones personificadas que guían su vida.",
    description:
    ...
    extraInfo: {
      curiosidades:
        "Intensamente fue aclamada por su representación precisa de la psicología emocional y ganó el Premio de la Academia a la Mejor Película Animada en 2016.",
    },
  },
  {
    id: "lilo-stitch",
    name: "Lilo y Stitch",
    shortDescription:
      "Una niña hawaiana y un alienígena travieso descubren el verdadero significado de la familia.",
    description:
    ...
    extraInfo: {
      curiosidades:
        "'Lilo y Stitch' es conocida por su enfoque en la cultura y las tradiciones de Hawái, así como por su banda sonora que incluye música hawaiana auténtica mezclada con canciones pop contemporáneas",
    },
  },
  {
    id: "big-hero",
    ...
    extraInfo: {
      curiosidades:
        "'Big Hero 6' está basada en el cómic de Marvel del mismo nombre, pero la trama y los personajes fueron adaptados para tener un enfoque más familiar y emocionalmente profundo",
    },
  },
  {
    id: "planeta-tesoro",
    ...
    extraInfo: {
      curiosidades:
        "'El Planeta del Tesoro' es una adaptación animada del clásico literario 'La isla del tesoro' de Robert Louis Stevenson, ambientada en un entorno futurista y espacial. ",
    },
  },
  {
    id: "mundo-jack",
    ...
    extraInfo: {
      curiosidades:
        "'El Extraño Mundo de Jack' fue inicialmente concebida por Tim Burton como un poema en los años 80, antes de ser adaptada en una película animada. Aunque a menudo se asocia con Tim Burton como director, en realidad fue dirigida por Henry Selick, quien también trabajó en 'Coraline'.",
    },
  },
  {
    id: "tarzan-1999",
    name: "Tarzán",
    shortDescription:
      "Una emocionante aventura animada sobre un niño criado por gorilas en la jungla africana.",
    description:
    ...
    imageUrl:
      "https://es.web.img3.acsta.net/pictures/14/03/17/11/47/596263.jpg",
    facts: {
      estreno: "1999",
    ...
    extraInfo: {
      curiosidades:
        "'Tarzan' fue el primer largometraje animado de Disney en utilizar tecnología digital para pintar los fondos. La película ganó el Premio Óscar a la Mejor Canción Original por 'You'll Be in My Heart' de Phil Collins, que se convirtió en un éxito internacional.",
    },
  },
];
